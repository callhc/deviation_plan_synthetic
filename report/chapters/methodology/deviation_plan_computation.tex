...
\begin{algorithm}[H]
\caption{\textsc{YenKShortestPaths}}\label{alg:yen}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]
\caption{\textsc{UpstreamDeviationPlans}}\label{alg:upstream}
\begin{algorithmic}[1]
...
Plans are not removed because of a
...
\begin{algorithm}[H]
\caption{\textsc{DepthAwareRewrite}}\label{alg:rewrite}
\begin{algorithmic}[1]
